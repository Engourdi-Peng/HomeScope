 ...
 * 
 * Handles /render-share/:slug requests
 * - Fetches analysis data from Supabase
 * - Injects dynamic meta tags (title, description, OG, Twitter)
 * - Returns full HTML with SEO meta in first response
