...
export function ExtensionHeader() {
  ...
  return (
    <header className="ext-topbar">
      ...
      <div className="ext-topbar-right">
        <div className="ext-topbar-status">
          <div className={`ext-status-dot ${getStatusDotClass()}`} />
          <span className="ext-topbar-status-text">{getStatusText()}</span>
        </div>
        <button
          type="button"
