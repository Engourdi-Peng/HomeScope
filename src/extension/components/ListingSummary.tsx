...
export function ListingSummary() {
  ...
  // 页面未识别：显示引导文案，不显示骨架屏
  if (propertyStatus === 'not_listing' || propertyStatus === 'error' || (!listingData && propertyStatus !== 'idle' && propertyStatus !== 'reading')) {
    return (
      <div className="ext-panel ext-listing-empty">
        <div className="ext-listing-empty-icon">
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            <path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z" />
            <polyline points="9 22 9 12 15 12 15 22" />
          </svg>
        </div>
        <p className="ext-listing-empty-text">Open a supported property listing to start.</p>
      </div>
    );
  }
