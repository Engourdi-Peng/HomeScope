...
interface SiteLayoutProps {
  children: ReactNode;
  /** 当页面已自带 footer 时可用此 prop 隐藏 layout footer。 */
  hideFooter?: boolean;
}
