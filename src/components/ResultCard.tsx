    ...
    <div className="w-full animate-in fade-in slide-in-from-bottom-12 duration-700 ease-out pb-24 relative z-10">
      ...
      <div className="space-y-0">
        ...
        {result.rent_fairness && (
          <div className="mb-10 bg-white rounded-3xl p-8 md:p-10 shadow-[0_1px_8px_rgba(0,0,0,0.06)] animate-in fade-in slide-in-from-bottom-8 duration-700 ease-out" style={{ animationDelay: '150ms' }}>
        ...
        {result.lightThermalGuide && (
          <div className="mb-10 bg-white rounded-3xl p-8 md:p-10 shadow-[0_1px_8px_rgba(0,0,0,0.06)] animate-in fade-in slide-in-from-bottom-8 duration-700 ease-out" style={{ animationDelay: '200ms' }}>
            <div className="flex items-center gap-3 mb-6">
        ...
        {result.agentLingoTranslation && result.agentLingoTranslation.shouldDisplay === true && result.agentLingoTranslation.phrases && result.agentLingoTranslation.phrases.length > 0 && (
          <div className="mb-10 bg-white rounded-3xl p-8 md:p-10 shadow-[0_1px_8px_rgba(0,0,0,0.06)] animate-in fade-in slide-in-from-bottom-8 duration-700 ease-out" style={{ animationDelay: '250ms' }}>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 rounded-xl bg-amber-50 flex items-center justify-center">
        ...
        {result.applicationStrategy && (
          <div className="mb-10 bg-white rounded-3xl p-8 md:p-10 shadow-[0_1px_8px_rgba(0,0,0,0.06)] animate-in fade-in slide-in-from-bottom-8 duration-700 ease-out" style={{ animationDelay: '300ms' }}>
            <div className="flex items-center gap-3 mb-6">
