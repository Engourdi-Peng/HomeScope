          ...
          <div className="prose prose-stone max-w-none space-y-8">
            <section>
              ...
              <p className="text-sm text-stone-600 leading-relaxed">
                This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our rental property analysis service ("we", "us", or "our"). We are committed to protecting your personal information in accordance with the Australian Privacy Act 1988 and the Australian Privacy Principles (APPs).
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-sm text-stone-600 space-y-2 ml-2">
                ...
                <li><strong>Property Data:</strong> Listing photos, descriptions, and details you upload for analysis</li>
