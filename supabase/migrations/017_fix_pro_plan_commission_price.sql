-- Migration: 017_fix_pro_plan_commission_price
-- Date: 2026-07-13
-- Description: Fix the pro plan purchase_amount inside
-- public.process_paddle_completed_transaction. The CASE expression for 'pro'
